...
/// Every member of our allegiance (ACE `Channel.AllegianceBroadcast`);
/// not the allegiance's Turbine room, which `turbine::ALLEGIANCE` is.
...
pub fn name(id: u32) -> &'static str {
    match id {
        ...
        ALLEGIANCE_BROADCAST => "Allegiance",
