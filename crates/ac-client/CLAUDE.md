...
`Client::tick` (`lib.rs:906-1438`), once a frame per session:
1. drain the socket and `World::apply` each message; server chat goes to `chat_message()`
   (`lib.rs:1835-2184`), which hands refusals in words to `hear_refusal()` (`refused.rs`)
...
`steps::STEPS` (`steps.rs:312-483`). A goal with no scorer is worth `(STEPS.len() - place) * 10`,
...
| critter | `critter`, `a_critter`, `ask_about_strangers` | `autoplay.rs:2201-2229`, `autoplay.rs:2246-2410`, `autoplay.rs:7341-7508` | `Fight.skip_critters`, `Client.appraisals` | critter | autoplay | critter |
...
| ledger | `tick_retag`, `autoplay_tag_arrivals`, `judge_loot`, `loot_action` | `autoplay.rs:2430-2529`, `autoplay.rs:4641-4793`, `autoplay.rs:6365-6436`, `crates/ac-loot/src/ledger.rs` | `Autoplay.ledger`, `Autoplay.pending_tags` | (`-p ac-loot ledger`) | autoplay | tag |
...
| ammo | `ready_ammo`, `autoplay_craft_ammo`, `choose_recipe`, `ammo_carried` | `autoplay.rs:2411-2429`, `autoplay.rs:6717-6865`, `growth.rs:2660-2692` | `Autoplay.crafting`, `Autoplay.wanted_ammo` | arrow | autoplay | ammo |
...
| team board | `autoplay_team`, `leader_mate`, `worst_hurt`, `rival_leader` | `autoplay.rs:934-1156`, `autoplay.rs:1271-1477`, `autoplay.rs:1975-2149`, `autoplay.rs:9518-9632`, `crates/ac-plugin/src/team.rs` | `Autoplay.team` (`TeamView.mates`), `Config.team` | leader | autoplay | mate |
...
| server chat | `chat_message`, `hear_arrival`, `hear_spell_attack` | `lib.rs:1835-2184`, `autoplay.rs:475-557`, `autoplay.rs:8533-8638` | `Autoplay.hit_by` | arriv | (crate root) | heard |
