...
| `action/mod.rs` | one vocabulary for what a front end asks: `action/resolve.rs` is the one place a name becomes a spell, a pack item, a ware, an object, the last corpse or a place |
