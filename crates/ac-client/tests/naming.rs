...
//! shrinks. Test names stay sentences and are not read here: a `#[cfg(test)]` item is cut out at
//! whatever indent it sits at, a helper inside an `impl` block included. Needs no game data.
